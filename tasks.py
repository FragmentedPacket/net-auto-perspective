...
def yamllint(context, local=INVOKE_LOCAL):
    """Run yamllint to validate formatting adheres to FragmentedPacket defined YAML standards."""
    exec_cmd = "yamllint ."
    run_cmd(context, exec_cmd, local)
...
def pydocstyle(context, local=INVOKE_LOCAL):
    """Run pydocstyle to validate docstring formatting adheres to FragmentedPacket defined standards."""
    exec_cmd = "pydocstyle ."
    run_cmd(context, exec_cmd, local)
